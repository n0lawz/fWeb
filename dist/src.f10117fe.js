...
function () {
  ...
  View.prototype.onRender = function () {}; // a function that is taking in our template and rendering html to the dom
...
var rootUrl = 'http://localhost:3000/users'; // UserProps will replace T in model class
